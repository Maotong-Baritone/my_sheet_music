...
list_file_path = os.path.join(output_dir, "handel_arias_list.txt")
...
try:
    ...
    if table:
        ...
        with open(list_file_path, "w", encoding="utf-8") as list_file:
            ...
            list_file.write("Aria | Composer | Opera | PDF URL\n")
            list_file.write("-" * 100 + "\n")
                ...
                if len(cells) > 1:
                    ...
                    if "Handel" in composer:
                        ...
                        if pdf_link_tag and pdf_link_tag.has_attr("href"):
                            ...
                            list_file.write(f"{aria:<30} | {composer:<40} | {opera:<20} | {pdf_url}\n")
                            ...
                            list_file.write(f"{aria:<30} | {composer:<40} | {opera:<20} | No PDF link found\n")
                            print(f"No PDF link found for '{aria}'.")

        print("\nFinished downloading Handel arias.")
